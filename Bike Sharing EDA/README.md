...
This project progresses through exploratory analysis, model development, model evaluation, and communication of results. Part 1 establishes the foundation by:
...
This emphasizes clear, interpretable analysis that informs future modeling decisions.
